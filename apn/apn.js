    ...
    automato[i].transicoes.forEach(transicao => {
        if(!ignorar.includes(transicao.numero)){
            ...
            if(iguais.length>0){
                ...
                label+="("+transicao.valor+","+transicao.desempilha+"/"+transicao.empilha+")";
                desenha_transicao(contexto,automato[i].x, automato[i].y,automato[transicao.destino].x, automato[transicao.destino].y,label);
            }else{transicao.valor+","+transicao.desempilha+"/"+transicao.desempilha
                let label = transicao.valor+","+transicao.desempilha+"/"+transicao.empilha;
                desenha_transicao(contexto,automato[i].x, automato[i].y,automato[transicao.destino].x, automato[transicao.destino].y,label);
            }
        }  
    });
